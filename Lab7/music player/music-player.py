...
class MusicPlayer():
    def __init__(self):
        ...
        self.volume = 1.0
        self.index = 0
        self.dynamic_play = get_image("play1.png")
    ...
    def get_songlist(self):
        ...
        self.queue.extend(list(filter(re.compile(r".*\.(mp3|ogg|wav)$").match, li)))
    ...
    def play_function(self):
        ...
        try:
            ...
            self.started = True
            self.dynamic_play= get_image("pause1.png")
        except:
...
music_player.read_songlist("songlist.json")
...
music_player.save_songlist("songlist.json")
